class XqccLetterAuditResult < ApplicationRecord # this is nearly identical to XqccLetterWrongTransmission
    include Sequence
    ...
    def set_ref_sequence
        ...
        next_sequence_id        = seq_nextval('xqcc_audit_result_letter_seq')
