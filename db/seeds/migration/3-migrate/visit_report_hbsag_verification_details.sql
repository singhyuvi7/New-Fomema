\echo "visit_report_hbsag_verification_details.sql loaded"
        ...
        LOOP
            FOREACH r IN ARRAY string_to_array(temp_row.datavalue, '|') LOOP
                ...
                IF result.details_type = 'CONDUCTED' THEN
                    INSERT INTO visit_report_hbsag_verification_details (
                        hbsag_verification_detailable_type,
                        hbsag_verification_detailable_id,
                        conducted,
...
\echo "visit_report_hbsag_verification_details.sql - hbsag screening done"

\echo "visit_report_hbsag_verification_details.sql ended"