\echo "visit_report_tpha_verification_details.sql loaded"
        ...
        LOOP
            FOREACH r IN ARRAY string_to_array(temp_row.datavalue, '|') LOOP
                ...
                IF result.details_type = 'CONDUCTED' THEN
                    INSERT INTO visit_report_tpha_verification_details (
                        tpha_verification_detailable_type,
                        tpha_verification_detailable_id,
                        conducted,
...
\echo "visit_report_tpha_verification_details.sql - vdrl done"

\echo "visit_report_tpha_verification_details.sql ended"