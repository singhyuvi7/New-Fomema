...
begin
    insert into public.copy_logs (description, start_at) values ('start backup nios history process', clock_timestamp()) returning id into v_copy_log_id_process;
    raise notice 'now: %', clock_timestamp();

insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table agent_history', 9 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table bad_payment_history', 30 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table district_office_history', 62 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table doctor_history', 65 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table employer_history', 103 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fw_appeal_approval_history', 151 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fw_appeal_history', 156 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fw_comment_history', 164 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fw_detail_history', 168 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fw_extra_comments_history', 170 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fw_quarantine_reason_history', 176 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fw_transaction_history', 180 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table group_doctor_pay_history', 186 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table group_xray_pay_history', 189 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table laboratory_history', 201 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table payment_req_history', 252 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table provider_history', 268 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table quarantine_release_req_history', 279 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table quarantine_status_history', 280 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table receipt_detail_history', 298 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table receipt_history', 301 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table receipt_history_medcon', 302 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table receipt_prefer_doctor_history', 306 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table receipt_usage_history', 310 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table refund_detail_history', 313 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table refund_history', 316 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table request_table_hist', 332 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table rfw_batch_transaction_history', 337 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table rfw_case_transaction_history', 339 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table rfw_comment_history', 341 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table rfw_detail_history', 343 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table rfw_fw_transaction_history', 345 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table service_provider_group_history', 368 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table user_session_history', 426 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table v_foreign_worker_history', 506 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table worker_cancel_history', 438 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table wrong_transmission_history', 446 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table xqcc_certificate_history', 450 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table xqua_release_req_history', 469 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table xray_adhoc_submit_history', 472 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table xray_history', 486 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table xray_submit_history', 501 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
