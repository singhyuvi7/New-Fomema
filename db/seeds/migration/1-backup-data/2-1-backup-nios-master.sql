...
begin
    insert into public.copy_logs (description, start_at) values ('start backup nios master process', clock_timestamp()) returning id into v_copy_log_id_process;

insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table agent_master', 10 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table bank_master', 33 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table bulletin_master', 43 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table capability_master', 46 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table code_master', 49 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table code_state_master', 50 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table condition_master', 52 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table country_master', 53 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table district_master', 60 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table doctor_master', 67 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table doctor_parameter_master', 70 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table draft_master', 81 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table dxprovider_master', 92 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table employer_alloc_master', 101 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table employer_master', 104 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fin_batch_master', 109 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fom_module_master', 114 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table fom_user_master', 123 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table foreign_clinic_master', 127 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table foreign_worker_master_cancel', 131 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table foreign_worker_master_delete', 132 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table icon_master', 190 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table ind_master', 195 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table invoice_master', 197 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table jobtype_master', 198 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table laboratory_master', 202 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table lab_rates_master', 210 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table module_master', 226 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table moh_master_quota', 230 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table myimms_country_master', 233 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table post_master', 267 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table radiographer_master', 289 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table radiologist_master', 291 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table report_group_master', 327 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table role_master', 348 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table scb_pay_master', 354 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table scb_pay_master_upload', 355 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table sequence_master', 364 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table service_providers_bank_master', 365 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table state_master', 373 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table state_master_rpt', 374 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table state_post_master', 375 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table um_module_master', 406 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table um_user_master', 408 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table usercap_master', 413 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table usermaster', 417 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table user_master', 424 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
    drop foreign table if exists nios_foreign.user_master;

    create foreign table if not exists nios_foreign.user_master (
        "uuid" numeric(10),
        "userid" varchar(20),
        "empid" varchar(20),
        ...
        "modification_date" timestamp,
        "branch_code" varchar(2)
    ) server nios_server options (schema 'NIOS1', table 'USER_MASTER');
    -- /foreign table

    -- copy table
    /* drop table if exists nios.user_master; */

    create table if not exists nios.user_master as select * from nios_foreign.user_master;
    -- /copy table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table v_appeal_master', 504 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table v_foreign_worker_master', 507 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table visit_plan_master', 428 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table visit_rpt_labmaster', 433 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table v_user_master', 526 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table xray_master', 487 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
...
insert into public.copy_logs (description, oracle_table_id, start_at) values ('start table zone_master', 503 , clock_timestamp()) returning id into v_copy_log_id_table; commit;
begin
    -- foreign table
