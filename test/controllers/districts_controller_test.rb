...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { code: @district.code, name: @district.name, state_id: @district.state_id } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { code: @district.code, name: @district.name, state_id: @district.state_id } }
