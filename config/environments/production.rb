Rails.application.configure do
  ...
  config.active_storage.service = ENV["ACTIVE_STORAGE_SERVICE"] || :production

  config.hosts << "#{ENV['APP_INT_SUBDOMAIN'].downcase}.#{ENV['APP_DOMAIN'].downcase}"
  config.hosts << "#{ENV['APP_EXT_SUBDOMAIN'].downcase}.#{ENV['APP_DOMAIN'].downcase}"
